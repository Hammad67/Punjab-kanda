...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { address: @party.address, name: @party.name, phone_number: @party.phone_number } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { address: @party.address, name: @party.name, phone_number: @party.phone_number } }
