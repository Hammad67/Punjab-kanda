...
ActiveRecord::Schema.define(version: 2022_02_11_044459) do
  ...
  create_table "send_messages", force: :cascade do |t|
    ...
    t.index ["party_id"], name: "index_send_messages_on_party_id"
  end

  add_foreign_key "send_messages", "drivers"
  add_foreign_key "send_messages", "parties"
end
